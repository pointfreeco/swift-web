  ...
  func testDocument() {
    let doc = html(
      ...
      [
        ...
        body([Html.class("home"), id("home")], [
          header([Html.class("site-header")], [
            svg(
...
"""
            ...
            a([href("/home"), onblur("ok ok ok")], ["Home"]),
            nav([Html.class("site-nav")], [
              div([
          ...
          main([Html.class("page-content")], [
            h1([Html.class("page-heading")], [
              ul([Html.class("episode-list")], [
                li([
                  span([Html.class("episode-metadata")], ["April 27, 2017"]),
                  h2([a([href("/episode/2")], ["Episode #2"])]),
                  p([
                    """
...
"""
                ...
                li([
                  span([Html.class("episode-metadata")], ["April 20, 2017"]),
                  h2([a([href("/episode/1")], ["Episode #1"])]),
                  p([
                    """
...
"""
            ...
            p([Html.class("rss-subscribe")], [
              "subscribe ",
              a([href("/rss.xml")], ["via RSS"])
              ])
            ]),

          hr([Html.class("pf-divider border-top m-ml0 m-mr0 m-mt0 m-mb0 bg-white")]),
          footer([Html.class("site-footer")], [
            h2(["The Site"]),
            ul([
            ...
            form([id("newsletter-form"), action("#"), Html.method(.post)], [
