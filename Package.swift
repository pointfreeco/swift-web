...
let package = Package(
  ...
  products: [
    ...
    .library(name: "ApplicativeRouterHttpPipelineSupport", targets: ["ApplicativeRouterHttpPipelineSupport"]),
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/pointfreeco/swift-html", .revision("7db1167")),
